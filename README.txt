Запуск приложения(примечания):
1. Код для входа: 1234 (нет денег на сервисе ))
2. Если хотите поменять в адресе значение счетчика, заходите в первый адрес и меняйте холодную воду(сканировать)
3. Экран История сделан Мок, не успели сделать бэк-энд для него.
